...
try:
    ...
    if app:
        ...
        find_element(automation_id="SplitContainer1", control_type="Pane", action="find" , main_window=main_window)
        ...
        filtered_sorted_data = [
            {"Material Code": " ABC123 ", "Deployment Date": "2025-07-31", "RPA Definition Remarks - GT": "pending"},
            {"Material Code": " DEF456 ", "Deployment Date": "2025-07-31", "RPA Definition Remarks - GT": "pending"},
            {"Material Code": " GHI789 ", "Deployment Date": "2025-07-31", "RPA Definition Remarks - GT": "pending"},
        ]

        for row in filtered_sorted_data:
            matcode = row.get("Material Code").stip()

            find_element_in_parent(
            parent_control_type="Table",
            child_control_type="DataItem", 
            parent_automation_id="GCInv",
